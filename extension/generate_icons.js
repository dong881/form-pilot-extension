...
// Simple SVG to PNG conversion using canvas (if available) or create a simple HTML file
...
<head>
    ...
    <style>
        ...
        .icon { display: inline-block; margin: 10px; background: white; padding: 10px; border-radius: 8px; }
        .size { font-family: Arial; font-size: 12px; color: #666; margin-top: 5px; }
    </style>
</head>
<body>
    <h2>Right-click and save each icon as PNG:</h2>
    
    <div class="icon">
        ${svgContent.replace('width="128" height="128"', 'width="16" height="16"')}
        <div class="size">16x16 - Save as icon-16.png</div>
    </div>
    
    <div class="icon">
        ${svgContent.replace('width="128" height="128"', 'width="32" height="32"')}
        <div class="size">32x32 - Save as icon-32.png</div>
    </div>
    
    <div class="icon">
        ${svgContent.replace('width="128" height="128"', 'width="48" height="48"')}
        <div class="size">48x48 - Save as icon-48.png</div>
    </div>
    
    <div class="icon">
        ${svgContent}
        <div class="size">128x128 - Save as icon-128.png</div>
    </div>
</body>
</html>`;

// Write the HTML file
fs.writeFileSync('icon_generator.html', htmlContent);

console.log('Icon generator HTML file created: icon_generator.html');
console.log('Open this file in a browser and right-click each icon to save as PNG files.');
console.log('Required files: icon-16.png, icon-32.png, icon-48.png, icon-128.png');